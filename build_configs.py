...
symbolic = ['-DCMAKE_BUILD_TYPE=Release', '-DDISABLE_LIBRARIES_BY_DEFAULT=NO', '-DLIBRARY_SYMBOLIC_ENABLED=TRUE']
symbolic_debug = ['-DCMAKE_BUILD_TYPE=Debug', '-DFAKE_STD_IN=./output.sas', '-DDISABLE_LIBRARIES_BY_DEFAULT=NO', '-DLIBRARY_SYMBOLIC_ENABLED=TRUE']
